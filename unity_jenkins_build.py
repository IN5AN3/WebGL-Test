...
UNITY_PATH = "/Applications/Unity {0}/Unity {0}.app/Contents/MacOS/Unity".format(UNITY_VERSION)
...
def doUnityBuild():
	...
	args.extend(["-executeMethod", "bnc.BuildOptions.buildFromCommandLineOptions"])
